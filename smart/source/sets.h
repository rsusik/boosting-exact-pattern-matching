...
char *SETTING_BUFFER[NumSetting] = {"rand2", "rand4", "rand8", "rand16", "rand32", "rand64", "rand128", "rand250", "italianTexts", "englishTexts", "frenchTexts", "chineseTexts", "midimusic", "genome", "protein", "english", "dna", "proteins", "sources", "dblp.xml", "pitches"};
int  SETTING_ALPHA_SIZE[NumSetting]= {2,4,8,16,32,64,128,250,128,128,128,128,128,64,64,176,16,25,227,96,133};
